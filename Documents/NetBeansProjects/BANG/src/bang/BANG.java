        ...
        ArrayList<Player> temp_play_order = new ArrayList();
            ...
            switch(players){
                ...
                case 6:
                    ...
                    Collections.shuffle(role_cards);
                    human = new Player(char_cards.get(0).name, char_cards.get(0).hp, role_cards.get(0).role, false);
                    Bot case6Bot1 = new Bot(char_cards.get(1).name, char_cards.get(1).hp, role_cards.get(1).role, true);
                    Bot case6Bot2 = new Bot(char_cards.get(2).name, char_cards.get(2).hp, role_cards.get(2).role, true);
                    Bot case6Bot3 = new Bot(char_cards.get(3).name, char_cards.get(3).hp, role_cards.get(3).role, true);
                    Bot case6Bot4 = new Bot(char_cards.get(4).name, char_cards.get(4).hp, role_cards.get(4).role, true);
                    Bot case6Bot5 = new Bot(char_cards.get(5).name, char_cards.get(5).hp, role_cards.get(5).role, true);
                    Bot case6Bot6 = new Bot(char_cards.get(6).name, char_cards.get(6).hp, role_cards.get(6).role, true);
                    break;
                case 7:
                    role_cards.add(new Role_Cards("Sheriff"));
                    role_cards.add(new Role_Cards("Renegade"));
                    ...
                    Bot case7Bot2 = new Bot(char_cards.get(2).name, char_cards.get(2).hp, role_cards.get(2).role, true);
                    Bot case7Bot3 = new Bot(char_cards.get(3).name, char_cards.get(3).hp, role_cards.get(3).role, true);
                    Bot case7Bot4 = new Bot(char_cards.get(4).name, char_cards.get(4).hp, role_cards.get(4).role, true);
                    Bot case7Bot5 = new Bot(char_cards.get(5).name, char_cards.get(5).hp, role_cards.get(5).role, true);
                    Bot case7Bot6 = new Bot(char_cards.get(6).name, char_cards.get(6).hp, role_cards.get(6).role, true);
                    Bot case7Bot7 = new Bot(char_cards.get(7).name, char_cards.get(7).hp, role_cards.get(7).role, true);
                    break;
                default:
